...
"./precompiled/protobuf_compiler/protoc-25.2/bin/protoc.exe" --plugin=protoc-gen-ts_proto="%CD%/../electron/node_modules/.bin/protoc-gen-ts_proto.cmd" --ts_proto_out="%CD%/../electron/src/shared/src" --ts_proto_opt=outputServices=grpc-js "./proto/grpc_api.proto" --ts_proto_opt=esModuleInterop=true
